...
final class Schema
{
    ...
    public static function ensureCmsSettings(Database $db): void
    {
        ...
        $defaults = [
            ...
            'playbook_slip_league_badge' => ['NFL', 'text'],
            'playbook_slip_top_tag' => ['EXAMPLE', 'text'],
            'playbook_slip_row1_title' => ['HOME -2.5', 'text'],
            'playbook_slip_row1_time' => ['8:20 PM ET', 'text'],
            'playbook_slip_row1_price' => ['-110', 'text'],
            'playbook_slip_row1_stake' => ['1 UNIT', 'text'],
            'playbook_slip_row2_title' => ['UNDER 44.5', 'text'],
            'playbook_slip_row2_time' => ['1:00 PM ET', 'text'],
            'playbook_slip_row2_price' => ['-105', 'text'],
            'playbook_slip_row2_stake' => ['1 UNIT', 'text'],
            'playbook_slip_row3_title' => ['AWAY MONEYLINE', 'text'],
            'playbook_slip_row3_time' => ['4:25 PM ET', 'text'],
            ...
            'playbook_cta1_text' => ['Get the Picks', 'text'],
            'playbook_cta1_url' => ['#plans', 'text'],
            'playbook_cta2_text' => ['See the Record', 'text'],
            'playbook_cta2_url' => ['/performance', 'text'],
            'hero_sec_cta_text' => ['See the Record', 'text'],
            'hero_sec_cta_url' => ['/performance', 'text'],
            'performance_kicker' => ['Public record', 'text'],
            'performance_title' => ['See the Record', 'text'],
            'performance_lede' => ['Transparent tracking of Orion Bets outcomes. Figures update from the local Action Network cache after each sync.', 'textarea'],
