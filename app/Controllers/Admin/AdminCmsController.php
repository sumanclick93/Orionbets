...
final class AdminCmsController extends Controller
{
    ...
    public function update(): never
    {
        ...
        $fields = [
            ...
            'playbook_slip_league_badge' => 'text',
            'playbook_slip_top_tag' => 'text',
            'playbook_slip_row1_title' => 'text',
            'playbook_slip_row1_time' => 'text',
            'playbook_slip_row1_price' => 'text',
            'playbook_slip_row1_stake' => 'text',
            'playbook_slip_row2_title' => 'text',
            'playbook_slip_row2_time' => 'text',
            'playbook_slip_row2_price' => 'text',
            'playbook_slip_row2_stake' => 'text',
            'playbook_slip_row3_title' => 'text',
            'playbook_slip_row3_time' => 'text',
            'playbook_slip_row3_price' => 'text',
            'playbook_slip_row3_stake' => 'text',
            'playbook_slip_footer_note' => 'text',
            'playbook_annot' => 'text',
            'playbook_footer_strip_title' => 'text',
            'playbook_footer_strip_sub' => 'text',
            'playbook_plans_kicker' => 'text',
            'playbook_plans_title' => 'text',
            'playbook_plans_lede' => 'textarea',
            'playbook_hero_title' => 'textarea',
            'playbook_hero_sub' => 'text',
            'playbook_hero_scrawl' => 'text',
            'playbook_cta1_text' => 'text',
            'playbook_cta1_url' => 'text',
            'playbook_cta2_text' => 'text',
            'playbook_cta2_url' => 'text',
            'hero_sec_cta_text' => 'text',
            'hero_sec_cta_url' => 'text',
            'performance_kicker' => 'text',
            'performance_title' => 'text',
            'performance_lede' => 'textarea',
